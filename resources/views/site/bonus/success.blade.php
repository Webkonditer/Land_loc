        ...
        <div class="main-content">
            <section>
                ...
                <div id="register" class="panel panel-default col-md-12">
                    <p><h3 class="widget-title line-bottom">Спасибо за выбор!</h3>
                    </p>
                    <p>Наш менеджер свяжется с Вами в течение 3-х суток. Если этого не произошло - свяжитесь с нами, написав на почту координатору отдела образования - tpdas@pamho.net</p>
