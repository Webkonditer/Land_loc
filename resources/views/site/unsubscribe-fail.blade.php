...
<body class="boxed-layout pb-40 pt-sm-0" data-bg-img="{{ asset('/images/pattern/p5.png') }}">
        ...
        <div class="main-content">
            <section>
                    ...
                    <div class="section-title text-center">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <br><br>
                                <h2 class="mt-0">Страница отписки от ежемесячного платежа</h2>
                ...
                <div id="register" class="panel panel-default col-md-12">
                    <p><h3 class="widget-title line-bottom">Ваша ссылка содержит ошибки. </h3>
                    </p>
                    <p></p>
                    <p>Попробуйте получить <a href="{{ route('unsubscribe') }}"><font color="green;">новую ссылку</font></a>.</p>
    ...
    <script type="text/javascript">
        ...
        function validation() {
            ...
            $("#pers").get(0).setCustomValidity('Для продолжения необходимо поставить галочку.');
