        ...
        <div class="main-content">
            <section>
                ...
                <div id="register" class="panel panel-default col-md-12">
                  <p><h3 class="widget-title line-bottom">Страница результата операции</h3></p>
					        <p></p>


                    <div class="col-md-6">
                        <p>Вы отменили операцию.</p>
                        <p>Выбрать другую форму участия вы можете на <a href="{{ route('home') }}"><font color="green;">главной странице</font></a>  сайта.</p>
                    </div>
                </div>
        </div>
    </div>
