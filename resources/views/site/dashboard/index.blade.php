                      ...
                      <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                              ...
                              @endif
                              <p>* Если Вы хотите изменить формат участия (ежемесячную подписку), нажмите ссылку "Отменить подписку",
                                а затем на <a href="{{ route('home')}}">главной странице сайта</a> выберите новый формат Вашего участия
                                и совершите первый платеж.</p>
                            </div>
                        </div>
