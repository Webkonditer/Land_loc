                ...
                <div id="register" class="panel panel-default col-md-12">
                  ...
                  <p>Автоматическое перенаправление на платежный шлюз...</p>
                    ...
                    <div class="col-md-6">
                      ...
                      <form id="payform" action='https://auth.robokassa.ru/Merchant/Recurring' method=POST>
                         <input type=hidden name=MrchLogin value="{{$mrh_login}}">
                         <input type=hidden name=OutSum value="{{$out_summ}}">
                         <input type=hidden name=InvId value="{{$inv_id}}">
                         <input type=hidden name=SignatureValue value="{{$crc}}">
                         <input type=hidden name=Receipt value={{$receipt}}>'previous_invoic_id' => $prev_inv_id,
                         <input type=hidden name=PreviousInvoiceID value={{$previous_invoic_id}}>
                         <input type=submit value='Отправить рекурентный платеж'>
                         </form>
